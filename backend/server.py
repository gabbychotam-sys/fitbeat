...
async def month_page_view(user_id: str, year: str, month: str):
    ...
    <body>
        <div class="container">
            ...
            <div class="summary">
                ...
                <div class="summary-stats">
                    <div>
                        <div class="summary-stat-value">⏱️ {time_str}</div>
                        <div class="summary-stat-label">זמן כולל</div>
                    </div>
                    <div>
                        <div class="summary-stat-value">❤️ {avg_hr}</div>
                        <div class="summary-stat-label">דופק ממוצע</div>
                    </div>
                    <div>
                        <div class="summary-stat-value">👟 {total_steps:,}</div>
                        <div class="summary-stat-label">צעדים</div>
                    </div>
                </div>
            </div>
            ...
            <div class="buttons">
                ...
                {'<button onclick="deleteAll()" class="delete-btn">🗑️ מחק את כל האימונים</button>' if workouts else ''}
            </div>
        ...
        <script>
            async function deleteAll() {{
                if (confirm('האם אתה בטוח שברצונך למחוק את כל האימונים?')) {{
                    try {{
                        const response = await fetch('/api/workout/user/{user_id}/all', {{ method: 'DELETE' }});
                        if (response.ok) {{
